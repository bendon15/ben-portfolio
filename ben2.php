...
<head>
  ...
  <meta name="description" content="Portfolio of Benedict Donato – Automation Specialist and Web Developer specializing in Zapier, PHP, and full-stack solutions.">
...
<body class="theme-blue">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="" class="nav-link" data-animate="scrolling"></a>
            </li>
          </ul>
        ...
        <div class="col-md-6 wow fadeInRight">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              ...
              <div class="details">
                <h5>Bachelor of Science in Computer Science Major in
            ...
            <li>
              ...
              <div class="details">
                ...
                <p>Secondary Level Passed NEAT Accreditation Dep.Ed</p>
              </div>
            </li>
            <li>
          ...
          <ul class="timeline mt-4 pr-md-5">
            ...
            <li>
              ...
              <div class="details">
                ...
                <p>Provides excellent and professional web developing service, audio and video editing for events.</p>
              </div>
            </li>
            <li>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>Skilled in Zapier automation,designing and optimizing seamless, automated workflows that connect diverse applications, streamlining business processes and enhancing operational efficiency. By leveraging Zapier's capabilities,
    ...
    <div class="container">
      ...
      <div class="gridder my-3">
        ...
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="../assets/img/work/Zaps1.png" data-fancybox data-caption="<h5 class='fg-theme'>Zapier Technical Engineer</h5> <p>Zapier Technical Engineer</p>">
            <img src="../assets/img/work/Zaps1.png" alt="">
            <div class="img-caption">
        ...
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="../assets/img/work/Zaps2.png" data-fancybox data-caption="<h5 class='fg-theme'>Zapier Certificate</h5> <p>Zapier Certificate</p>">
            <img src="../assets/img/work/Zaps2.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Zapier Certificate</h5>
              <p>Zapier Certificate</p>
            </div>
          </div>
        </div>
  ...
  <div class="vg-page page-portfolio" id="other-projects">
    <div class="container">
      <div class="text-center wow fadeInUp">
        <div class="badge badge-subhead">Other Projects</div>
      </div>
      <h1 class="text-center fw-normal wow fadeInUp">Other Websites & Automations I Made</h1>

      <div class="row mt-5 g-4">

        <!-- Project 1 -->
        <div class="col-md-6 col-lg-4">
          <div class="card card-service p-3 h-100 text-center wow fadeInUp project-card-hover">
            <div class="img-place mb-3">
              <a href="../assets/img/work/mobile1.jpg" data-fancybox="gallery" data-caption="Feline Food and Accessories Ordering Website">
                <img src="../assets/img/work/mobile1.jpg" alt="Screenshot of Cat Food Ordering Website" class="img-fluid rounded">
              </a>
            </div>
            <h5 class="fg-theme">Feline Food and Accessories Ordering Website</h5>
            <p>A mobile-friendly store built for pet lovers. Features include:</p>
            <ul class="text-start small">
              <li>✔️ Responsive on desktop and mobile</li>
              <li>✔️ Admin dashboard with sales and alerts</li>
              <li>✔️ Booking with email notifications</li>
              <li>✔️ GCash/BDO QR payments</li>
              <li>✔️ Tawk.to live chat support</li>
            </ul>
            <a href="https://testsiteben.ct.ws/" class="btn btn-theme mt-auto" target="_blank" rel="noopener noreferrer">Visit Live Site</a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card card-service p-3 h-100 text-center wow fadeInUp project-card-hover">
            <div class="img-place mb-3">
              <a href="../assets/img/work/workflow1.jpg" data-fancybox="gallery" data-caption="Smart Lead Routing from Website Form">
                <img src="../assets/img/work/workflow1.jpg" alt="Workflow automation interface" class="img-fluid rounded">
              </a>
            </div>
            <h5 class="fg-theme">Smart Lead Routing from Website Form</h5>
            <p>This automation intelligently routes website inquiries based on lead type using Zapier Paths.</p>
            <ul class="text-start small">
              <li>📥 Webhook Catch Hook receives form data</li>
              <li>🧹 Filters out spam or invalid emails</li>
              <li>🔀 Paths by Zapier:
                <ul>
                  <li><strong>Sales:</strong> HubSpot + Gmail + Slack + Mailchimp</li>
                  <li><strong>Support:</strong> Zendesk + Slack + Gmail</li>
                  <li><strong>Other:</strong> Gmail + Mailchimp</li>
                </ul>
              </li>
              <li>⚙️ Tools Used: Zapier, Gmail, Slack, Mailchimp, HubSpot</li>
            </ul>
            <p class="mt-2 small">✅ Improves team response and CRM organization.</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card card-service p-3 h-100 text-center wow fadeInUp project-card-hover">
            <div class="img-place mb-3">
              <a href="../assets/img/work/workflow2.jpg" data-fancybox="gallery" data-caption="Shopify Order Processing Workflow (Zapier)">
                <img src="../assets/img/work/workflow2.jpg" alt="Shopify order automation UI" class="img-fluid rounded">
              </a>
            </div>
            <h5 class="fg-theme">Shopify Order Processing Workflow (Zapier)</h5>
            <p>This Zapier flow automates order processing from Shopify:</p>
            <ul class="text-start small">
              <li>🛒 Trigger: New Shopify order</li>
              <li>🧮 Update inventory in Google Sheets</li>
              <li>🧾 Generate invoice via QuickBooks</li>
              <li>📦 Send order to Slack fulfillment team</li>
              <li>📬 Email customer confirmation via Gmail</li>
            </ul>
            <p class="mt-2 small">✅ Enhances accuracy, saves time, and improves customer experience.</p>
          </div>
        </div>
